...
class AreaAttnModel(Module):
    ...
    def fit(self, train_data, validation_data=None):
        ...
        for epoch in range(1, self.opt['epochs'] + 1):
            ...
            total_loss = []
            current_loss = 0.
            # train_loader = torch.utils.data.DataLoader(train_data, num_workers=4, batch_size=self.opt['batch_size'],
    ...
    def predict(self, test_data, k=15):
        ...
        for data in test_loader:
            ...
            # candidate_data1 = candidate_data[candidate_data>17380]
            # print(candidate_data1)
            ...
            # targets, scores, candidate_data = self._forward(data)
            # sub_scores = torch.gather(scores, 1, candidate_data).topk(k)[1]
            # sub_scores = torch.gather(candidate_data, 1, sub_scores)
